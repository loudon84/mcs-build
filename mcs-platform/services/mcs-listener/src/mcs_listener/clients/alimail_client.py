...
from mcs_listener.clients.exceptions import AlimailAuthError, AlimailAPIError, AlimailClientError
...
class OAuthManager:
    ...
    async def refresh_token(self) -> str:
        ...
        try:
            ...
            raise AlimailAuthError(f"Failed to get access token: {e.response.status_code}") from e
