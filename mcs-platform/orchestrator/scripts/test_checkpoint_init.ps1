# PostgresCheckpointStore 初始化测试脚本 (PowerShell)
# 
# 使用方法：
#   .\scripts\test_checkpoint_init.ps1
#   或
#   cd scripts; .\test_checkpoint_init.ps1
...
Write-Host "PostgresCheckpointStore 初始化测试" -ForegroundColor Cyan
Write-Host "=" * 80 -ForegroundColor Cyan
Write-Host ""
...
$pythonScript = Join-Path $ScriptDir "test_checkpoint_init.py"
